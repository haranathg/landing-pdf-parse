...
allowed_origins = os.getenv("ALLOWED_ORIGINS", "http://localhost:3000,http://localhost:5173,https://complicheck-docstudio.onrender.com,https://complicheckai.onrender.com").split(",")
